        ...
        event() {
            ...
            this.$submit.onclick = function () {
                ...
                for (let i = 0; i < $pAll.length; i++) {
                    ...
                    console.log(_this.$phone.value);
                    console.log(_this.$password.value);
                    sendAjax('../../../server/php/register.php', {
                        'userphone': _this.$phone.value,
                        'userpwd': _this.$password.value
                    })
                    
                }
                // e.returnValue = true;
                // this.$submit.addEventListener('submit',function(){
                //     this.removeAttribute('disabled');
                // })               
                //当所有input表单失去焦点时，验证通过，恢复提交按钮的功能
                //submit_flag = true;
            }
            /* 提交注册--结束 */
        },
